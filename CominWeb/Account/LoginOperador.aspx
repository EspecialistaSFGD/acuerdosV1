<%@ Page Title="Iniciar sesión" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="LoginOperador.aspx.vb" Inherits="CominWeb.LoginOperador" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div style=" width: 100%;">
        &nbsp; &nbsp; &nbsp; &nbsp;
        <asp:Label ID="Label1" runat="server" Font-Size="15pt" Font-Bold="true" Text=" Iniciar sesión :: "> </asp:Label>&nbsp;
        <br />
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
		        ...
		        <div class="wrap-login100 p-l-35 p-r-35 p-t-35 p-b-30">
			        <form class="login100-form validate-form">
				        <span class="login100-form-title p-b-20">
					        Ingresar a MODO EJECUTOR
				        </span>
                        <div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="sucursalCB" runat="server" Height="70px" AutoPostBack="true"
                                DataSourceID="SDS_selectSucursales" DataTextField="nombre" 
                                DataValueField="sucursalID" Width="100%" Font-Size="20"
				        ...
				        <div class="wrap-input100 validate-input">
                            <asp:DropDownList ID="usuarioCB" runat="server" Height="70px" Font-Size="20"
                                DataSourceID="SDS_P_selectUsuario" DataTextField="nombreUser" 
                                DataValueField="usuarioID" Width="100%" class="input100"
                                style="padding: 0 25px 0 25px; border:1px" >
                            </asp:DropDownList>
					        <span class="focus-input100-1"></span>
					        <span class="focus-input100-2"></span>
				        ...
				        <div class="wrap-input100 rs1 validate-input" data-validate="Ingrese contraseña">
                            <asp:TextBox ID="claveUser" runat="server" class="input100" TextMode="Password" Font-Size="20" placeholder="Password"></asp:TextBox>
					        <span class="focus-input100-1"></span>
					        <span class="focus-input100-2"></span>
				        </div>
    ...
    SelectCommand="P_selectUsuarioOperador" SelectCommandType="StoredProcedure">
        <SelectParameters>
