<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Form_SituacionAct.aspx.vb" Inherits="CominWeb.Form_SituacionAct" %>
    ...
    <form id="form1" runat="server">
                ...
                <telerik:radgrid ID="RadGrid1" runat="server" Culture="es-ES" DataSourceID="SDS_P_selectSituacion" Skin="WebBlue" 
                    ...
                    <MasterTableView DataSourceID="SDS_P_selectSituacion" Font-Size="8pt" PageSize="5" 
                        NoMasterRecordsText="No existen registros." DataKeyNames="situacionId" 
                        ClientDataKeyNames="situacionId, pcbId" CommandItemDisplay="Top">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="situacionId" FilterControlAltText="Filter situacionId column" 
                            HeaderText="situacionId" ReadOnly="True" SortExpression="situacionId" UniqueName="situacionId"
                            Display="false">
                    ...
                    <EditFormSettings EditFormType="WebUserControl" 
                        UserControlName="~/SSFD/Form_SituacionAct_WUC.ascx">
        ...
        <asp:SqlDataSource ID="SDS_P_selectSituacion" runat="server" 
            SelectCommand="ssfd.P_selectSituacion" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:Parameter DefaultValue="0" Name="situacionId" Type="Int32" />
