...
Public Class Form_SituacionAct
    Inherits System.Web.UI.Page
    Dim sw_ejecutaSQL As New SW_EjecutaSQL_DA

    Private Sub Form_SituacionAct_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Protected Sub RadGrid1_UpdateCommand(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.UpdateCommand
        Dim userControl As UserControl = CType(e.Item.FindControl(GridEditFormItem.EditFormUserControlID), UserControl)
        Dim editedItem As GridEditableItem = CType(e.Item, GridEditableItem)
        Dim situacionId As Integer = editedItem.OwnerTableView.DataKeyValues(editedItem.ItemIndex)("situacionId").ToString()
    ...
    Private Sub sqlProcess(ByVal situacionIdv As Integer, ByVal pcbIdv As Integer, ByVal descripcionv As String,
        ...
        Dim cad As String = " exec ssfd.P_crearUpdateSituacionAct " & situacionIdv.ToString &
