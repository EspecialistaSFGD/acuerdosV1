<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Form_SituacionProblem_WUC.ascx.vb" Inherits="CominWeb.Form_SituacionProblem_WUC" %>
    ...
    <tr>
        ...
        <td style="text-align:left; width:85%; padding:5px 0 5px 0;" rowspan="2" >
            <asp:TextBox ID="descripcionTB" runat="server" Width="90%" Rows="5" class="form-control"
                TextMode="MultiLine" placeholder="Descripción de la situación de la problemática."></asp:TextBox>
        </td>
    </tr>
</table>
