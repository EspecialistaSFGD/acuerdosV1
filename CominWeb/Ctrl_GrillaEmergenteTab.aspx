<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Ctrl_GrillaEmergenteTab.aspx.vb" Inherits="CominWeb.Ctrl_GrillaEmergenteTab"%>
...
<body>
    ...
    <div style="min-Width:100%;">
        <table width="100%">
            <tr>
                <td style="width:50%">
                    <telerik:RadTextBox ID="txt_buscar" Runat="server" Skin="Windows7" Width="100%" Text="" autocomplete="off"
                        Font-Size="16pt" Height="35px" AutoCompleteType="Disabled">
                ...
                <td colspan="3">
                    ...
                    <telerik:RadGrid ID="RadGrid_Principal" runat="server" Skin="WebBlue" Culture="es-ES" 
                        ...
                        <MasterTableView
                                ...
                                AutoGenerateColumns="True" Font-Size="13pt" NoMasterRecordsText="No existen registros.">
