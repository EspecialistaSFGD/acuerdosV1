...
Public Class SW_partidas_DA
    Public Function P_selectPartidas(ByVal partidaID As String, centroCostoID As String, sucursalID As Integer) As DataTable
        Dim db As Database = DatabaseFactory.CreateDatabase(variableGlobalConexion.nombreCadenaCnx)
        Dim cmd As DbCommand = db.GetStoredProcCommand("P_selectPartidas")
