<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Form_asistenciaEventosExp.aspx.vb" Inherits="CominWeb.Form_asistenciaEventosExp" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function renewSession() {
                ...
                document.getElementById('renewSession').src = '/PROFAKTOWEB/SessionActiva.aspx?par=' + Math.random();
            }
...
<img src="/PROFAKTOWEB/SessionActiva.aspx" name="renewSession" id="renewSession" width="1px" height="1px"/>
