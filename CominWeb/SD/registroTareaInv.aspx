<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registroTareaInv.aspx.vb" Inherits="CominWeb.registroTareaInv" %>
                            ...
                            <tr>
                                ...
                                <td style="width:35%; padding:5px" >
                                        <asp:DropDownList ID="faseCB" runat="server" DataSourceID="SDS_SD_P_selectFaseInv" DataTextField="nombre" 
                                                DataValueField="faseID" Width="100%" TabIndex="12" class="form-control" Height="30px" Font-Size="11px" 
                                ...
                                <td style="width:35%; padding:5px" >
                                        <telerik:raddatepicker ID="fechaRDP" runat="server" RenderMode="Lightweight"
                                            Width="100%" Culture="es-PE" MaxDate="2030-12-31" Height="30px" Font-Size="11px" 
                                            Skin="Metro">
                            ...
                            <tr>
                                ...
                                <td style="width:35%; padding:5px" >
                                        ...
                                        <asp:DropDownList ID="etapaCB" runat="server" DataSourceID="SDS_SD_P_selectEtapaInv" DataTextField="nombre" 
                                                DataValueField="EtapaID" Width="100%" TabIndex="12" class="form-control" Height="30px" Font-Size="11px" 
                                                AppendDataBoundItems="True" AutoPostBack="true">
                                                <asp:ListItem Selected="True" Value="0" > - Seleccione - </asp:ListItem>
                                        </asp:DropDownList>
                                </td>
                             ...
                             <tr>
                                ...
                                <td style="padding:5px" colspan="3">
                                        <asp:DropDownList ID="hitoCB" runat="server" DataSourceID="SDS_SD_P_selectHitoInv" DataTextField="nombre" 
                                                DataValueField="hitoId" Width="100%" TabIndex="12" class="form-control" Height="30px" Font-Size="11px" 
