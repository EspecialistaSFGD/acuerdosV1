<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="registroConfirma.aspx.vb" Inherits="CominWeb.registroConfirma" %>
...
<body>
    <form id="form1" runat="server">
        <div class="top_nav">
          <div class="nav_menu">
              <div class="col-md-12 col-sm-12 col-xs-12 form-group" style="text-align:center; font-weight:bold;font-size:20px; padding-top:10px">
                      Seguimiento
                </div>
          </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 form-group" style="text-align:center; padding-top:10px">
                <center>
                        <table style="width:95%" border="0">
                            <tr>
                                <td style="width:15%; padding:5px; Font-Size:12px; font-weight:500">
                                    <asp:Label ID="label1" runat="server" Font-Size="9pt" >ENTIDAD</asp:Label>
                                </td>
                                <td style="padding:5px">
                                    <asp:Label ID="entidadLB" runat="server" Font-Size="9pt" ></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:15%; padding:5px; Font-Size:12px; font-weight:500">
                                    <asp:Label ID="label2" runat="server" Font-Size="9pt" >AUTORIDAD</asp:Label>
                                </td>
                                <td style="padding:5px">
                                    <asp:Label ID="autoridadLB" runat="server" Font-Size="9pt" ></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:15%; padding:5px; Font-Size:12px; font-weight:500">
                                    <asp:Label ID="label3" runat="server" Font-Size="9pt" >TELEFONO</asp:Label>
                                </td>
                                <td style="padding:5px">
                                    <asp:TextBox ID="telefonoTB" Font-Size="10" runat="server" Width="100%" autocomplete="off" TabIndex="1" MaxLength="30"
                                            placeholder="" class="form-control" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="width:15%; padding:5px; Font-Size:12px; font-weight:500">
                                    <asp:Label ID="labelEstadoLB" runat="server" Font-Size="9pt" >ESTADO</asp:Label>
                                </td>
                                <td style="padding:5px">
                                    <asp:DropDownList ID="estadoCB" runat="server" Width="100%" Font-Size="9" 
                                             DataSourceID="SDS_SD_P_selectEstadoTipo" DataTextField="nombre" class="form-control"
                                            DataValueField="ID" TabIndex="2" AppendDataBoundItems="True">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="padding:5px">
                                        <asp:TextBox ID="observacionTB" Font-Size="10" runat="server" Width="100%" autocomplete="off" TabIndex="1" MaxLength="150"
