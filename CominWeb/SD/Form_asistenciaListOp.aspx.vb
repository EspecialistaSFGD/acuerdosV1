...
Public Class Form_asistenciaListOp
    Inherits System.Web.UI.Page

    Dim sw_asistente_DT As New DataTable
    Dim sw_asistente As New SW_SD_asistente_DA

    Private Sub Form_asistenciaListOp_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("gjXtIkEroS").ToString = "SD_SSFD" Then
            ...
            SDS_SD_P_selectAsistentesList.ConnectionString = ConfigurationManager.ConnectionStrings(variableGlobalConexion.nombreCadenaCnx).ConnectionString
    ...
    Private Sub CreateExcelFile()
        ...
        sw_asistente_DT = sw_asistente.SD_P_selectAsistentesListExport(desdeRDP.SelectedDate.Value.ToString("dd/MM/yyyy"), hastaRDP.SelectedDate.Value.ToString("dd/MM/yyyy"), 0, "", "", cbo_evento.SelectedValue)
