...
Public Class Form_asistenciaEventos
    ...
    Private Sub Form_asistenciaEventos_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Protected Sub nuevoB_Click(sender As Object, e As EventArgs) Handles nuevoB.Click
        ...
        If cad.Length > 0 Then
            ...
            Catch ex As Exception
                Me.tituloLB.Text = "INGRESE NUEVAMENTE LOS DATOS"
            End Try
        End If
    End Sub
