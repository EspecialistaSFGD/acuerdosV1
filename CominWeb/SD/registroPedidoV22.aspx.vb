...
Public Class registroPedidoV22
    ...
    Private Sub registroPedidoV22_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Private Sub frmguardar()
        ...
        '        grupoCB.SelectedValue, cbo_departamento1.SelectedValue, prioridadTerritorialTB.Text.ToString.Trim, objetivoTB.Text.ToString.Trim, intervencionTB.Text.ToString.Trim, aspectoTB.Text.ToString.Trim, cuisTB.Text.ToString.Trim)
        'ElseIf SW_pedidoDT.Rows(0).Item(4) = "P" Then
        '    codigoid = SW_pedidoDA.SD_P_crearUpdatePrioridadAcuerdo(Session("pedido"), Me.Request.QueryString("codevento").ToString,
        '        grupoCB.SelectedValue, cbo_provincia1.SelectedValue, prioridadTerritorialTB.Text.ToString.Trim, objetivoTB.Text.ToString.Trim, intervencionTB.Text.ToString.Trim, aspectoTB.Text.ToString.Trim, cuisTB.Text.ToString.Trim)
        'End If
