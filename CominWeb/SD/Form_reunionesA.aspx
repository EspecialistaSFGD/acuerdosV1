<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Form_reunionesA.aspx.vb" Inherits="CominWeb.Form_reunionesA" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function verreu(codigoid, estReg) {
                location.href = "Form_reunionesDetA.aspx?7B611A09B990B80849DBE7AF822D63E466D552839D9EC6E0=" + '<%= Me.Request.QueryString("7B611A09B990B80849DBE7AF822D63E466D552839D9EC6E0")%>' + "&gjXtIkEroS=SD_SSFD&reid=" + codigoid + "&estReg=" + estReg + "&iacp=" + '<%= Me.Request.QueryString("iacp")%>' + "&enti=" + '<%= Me.Request.QueryString("enti")%>' + "&sup=" + '<%= Me.Request.QueryString("sup")%>' + "&en=" + '<%= Me.Request.QueryString("en")%>' + "&ksjcmj=" + '<%= Me.Request.QueryString("ksjcmj")%>'; <%-- + "&tipo=" + '<%= Me.Request.QueryString("tipo")%>' + "&ubig=" + '<%= Me.Request.QueryString("ubig")%>' + "&de=" + '<%= Me.Request.QueryString("de")%>' + "&hsndktumg=" + '<%= Me.Request.QueryString("hsndktumg")%>' + "&en=" + '<%= Me.Request.QueryString("en")%>' + "&sup=" + '<%= Me.Request.QueryString("sup")%>' + "&enti=" + '<%= Me.Request.QueryString("enti")%>' + "&iacp=" + '<%= Me.Request.QueryString("iacp")%>';--%>
                return false;
            }
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12" style="text-align:center">
                ...
                <telerik:radgrid ID="RadGrid1" runat="server" Culture="es-ES" Width="100%"
                    ...
                    <MasterTableView DataSourceID="SDS_SD_P_selectListReuniones" NoMasterRecordsText="No existen registros." PageSize="30">
