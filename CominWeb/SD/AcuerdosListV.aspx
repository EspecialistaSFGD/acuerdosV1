    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function verOrdenServicioLog(codigo, codevento, codsector, secto) {
                location.href = "registroAcuerdosV.aspx?lkjasdliwupqwinasndlkkjasdwuewue=lksajdlaksjdlnlnkj34lkjlk324nkjn2l3k4k567lk5786666lk76nwnbmnkjhkjasdhasdhurtioenmbxcvkjh&gjXtIkEroS=SD_SSFD&pkASIEMVadASDkwdasdmad=jasdwdNasdJasd135&codigoid=" + codigo + "&codevento=" + codevento + "&codsector=" + codsector + "&secto=" + secto; 
                return false;
            } 

            function frmnovado() {
                var codevento = document.getElementById('<%= cbo_evento.ClientID%>').value;
                location.href = "registroAcuerdosV.aspx?lkjasdliwupqwinasndlkkjasdwuewue=lksajdlaksjdlnlnkj34lkjlk324nkjn2l3k4k567lk5786666lk76nwnbmnkjhkjasdhasdhurtioenmbxcvkjh&gjXtIkEroS=SD_SSFD&pkASIEMVadASDkwdasdmad=jasdwdNasdJasd135&codigoid=0&codevento=" + codevento + "&codsector=0&secto=0";
                return false;
            }
