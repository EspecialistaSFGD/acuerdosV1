...
Public Class Form_asistenciaEventosExp
    ...
    Private Sub Form_asistenciaEventosExp_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
    ...
    Protected Sub nuevoB_Click(sender As Object, e As EventArgs) Handles nuevoB.Click
        Dim cad As String = ""
        cad = " exec SD_P_crearUpdateAsistente " & ViewState("id").ToString & ", " & cbo_tipoDocumento.SelectedValue.ToString & ", '" & nroDocTB.Text.ToString & "','" & apePaternoTB.Text.ToString & "','" &
    ...
    Private Sub busca(ByVal num As String)
        ...
        Else
            Me.tituloLB.ForeColor = Color.Black
            sw_asistente_DT = sw_asistente.SD_P_selectAsistentes(9, 0, num.ToString, "", cbo_evento.SelectedValue)
            If sw_asistente_DT.Rows.Count <> 0 Then
                ...
                nroDocTB.Focus()
                'Dim cad As String = ""
                ''cad = " exec SD_P_crearUpdateAsistencias 0, " & sw_asistente_DT.Rows(0).Item(0).ToString &
                ''    ", " & cbo_evento.SelectedValue
    ...
    Private Sub CreateExcelFile()
        ...
        sl.SetColumnStyle(1, 10, styleCon)
