<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Form_asistenciaListOp.aspx.vb" Inherits="CominWeb.Form_asistenciaListOp" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 form-group" style="text-align:center">
            <asp:Button ID="exportarB" runat="server" Text="EXPORTAR" class="styleMe1" Width="90%" Height="50px" Font-Size="14" />
        </div>
        <div class="col-md-12 col-sm-12 col-xs-12 form-group" style="text-align:center">
                <telerik:radgrid ID="RadGrid1" runat="server" Culture="es-ES" 
                    DataSourceID="SDS_SD_P_selectAsistentesList" Skin="MetroTouch" 
                    ...
                    <MasterTableView DataSourceID="SDS_SD_P_selectAsistentesList" NoMasterRecordsText="No existen registros.">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="tipo" FilterControlAltText="Filter tipo column" 
                            HeaderText="Tipo" SortExpression="tipo" UniqueName="tipo" AutoPostBackOnFilter="true" 
                            FilterControlWidth="100%" ShowFilterIcon="false">
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Left" />
                        </telerik:GridBoundColumn>
    ...
    <asp:SqlDataSource ID="SDS_SD_P_selectAsistentesList" runat="server"  
        SelectCommand="SD_P_selectAsistentesList" 
